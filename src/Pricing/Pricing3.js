    ...
    return (
        <>
            ...
            <section id="pricing_three">
                ...
                <div className="container-fluid col-md-10 mx-auto m-5 p-5 d-none d-md-block">
                    <div className="row">
                ...
                <div className="container-fluid col-md-10 mx-auto m-5 p-5 d-md-none">
                    <div className="row">
                        ...
                        {/* <!-- Carousel --> */}
                        <div id="demo3" class="carousel slide col-md-8" data-bs-ride="carousel">
                            {/* <!-- Indicators/dots --> */}
                            <div class="carousel-indicators">
