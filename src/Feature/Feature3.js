    ...
    <div className='row justify-content-center'>
      ...
      <div className='row mt-5 mb-5'>
        <div className='col-md-3 col-sm-6 mb-4'>
            ...
            <div className="service-icon1 text-light rounded-4 fs-4 text-center mb-4" style={{ width: 50, height:50 }}>
            ...
            <h6 className='card-title'>Grow Your Business</h6>
            <p className='card-text font-light'>Far far away, behind the mountains, far from the countries Vokalia and
                 Consonantia</p>
            </div>
        ...
        <div className='col-md-3 col-sm-6 mb-4'>
            ...
            <div className="service-icon2 text-light rounded-4 fs-4 text-center mb-4" style={{ width: 50, height:50 }}>
            ...
            <h6 className='card-title'>Build Products</h6>
            <p className='card-text font-light'>Far far away, behind the mountains, far from the countries Vokalia and
                 Consonantia</p>
            </div>
        ...
        <div className='col-md-3 col-sm-6 mb-4'>
            ...
            <div className="service-icon3 text-light rounded-4 fs-4 text-center mb-4" style={{ width: 50, height:50 }}>
            ...
            <h6 className='card-title'>Success Every Day</h6>
            <p className='card-text font-light'>Far far away, behind the mountains, far from the countries Vokalia and
                 Consonantia</p>
            </div>
        ...
        <div className='col-md-3 col-sm-6 mb-4'>
            ...
            <div className="service-icon4 text-light rounded-4 fs-4 text-center mb-4" style={{ width: 50, height:50 }}>
            ...
            <h6 className='card-title'>Bring Ideas to Life</h6>
            <p className='card-text font-light'>Far far away, behind the mountains, far from the countries Vokalia and
                 Consonantia</p>
            </div>
