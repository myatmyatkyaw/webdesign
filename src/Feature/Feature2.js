  ...
  return (
    <div className='featu2'>
      ...
      <div className='col-md-7'>
            <div className='card card-body w-76 border-0 shadow'>
            <img src={Image4} alt='image4' className='image-fluid' width={590} height={400}/> 
            </div>
        </div>
      <div className='col-md-5'>
        <div className='card card-body border-0 me-5 mb-2'>
            <div className='row'>
                <div className='col-md-2'>
                    <div class="service-icon1 text-light rounded-4 fs-5 text-center" style={{ width: 40, height:40 }}>
                ...
                <div className='col-md-10'>
                    ...
                    <p className='card-text'>Far far away, behind the mountains, far from the countries Vokalia and
                        Consonantia</p>
                </div>
        ...
        <div className='card card-body me-5 border-0 mb-2'>
            <div className='row'>
                <div className='col-md-2'>
                <div class="service-icon2 text-light rounded-4 fs-5 text-center" style={{ width: 40, height:40 }}>
